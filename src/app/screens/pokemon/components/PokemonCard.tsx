            ...
            { pokemonList.map((pokemon: any, index: number) => (
                    ...
                    >
                        <div className="relative overflow-hidden p-3 w-64 h-full">
                            ...
                            >
                                <div style={{ position: 'absolute', top: '0', right: '0', width: '150px', height: '150px', objectFit: 'cover', borderRadius: '3px'}}>
                                <Image
                                        src="/pokeball.svg"
                                        alt="Logo"
                            ...
                            <div className='relative z-10 flex items-center flex-col'>
                                ...
                                <img src={hoveredCards[index] ? pokemon.sprites.other.home.front_shiny : pokemon.sprites.other.home.front_default} 
